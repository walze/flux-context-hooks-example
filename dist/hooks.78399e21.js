...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"dispatcher.jsx":[function(require,module,exports) {
"use strict";
...
var useDispatcher = function useDispatcher() {
  /** @type { IDispatcher } */
  var dispatcher = (0, _react.useContext)(_Store.StoreContext)[1];
  return dispatcher;
};

exports.useDispatcher = useDispatcher;
},{"react":"node_modules/react/index.js","./Store":"Store.jsx"}],"Actions.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ACTION_TYPES = exports.useActions = void 0;
...
var ACTION_TYPES_DECLARATIONS = {
  ADD_COUNTER: 0,
  REMOVE_COUNTER: 0,
  TEST: ''
};
var ACTION_TYPES_ARRAY = Object.keys(ACTION_TYPES_DECLARATIONS);
/**
 * @param { import("./dispatcher").IDispatcher } dispatcher 
 * @return { IDecoratedActions }
 */

var reduceTypes = function reduceTypes(dispatcher) {
  return ACTION_TYPES_ARRAY.reduce(function (acc, type) {
    return _objectSpread({}, acc, _defineProperty({}, type, function (payload) {
      return dispatcher({
        type: type,
        payload: payload
      });
...
var useActions = function useActions() {
  return reducedTypes || (reducedTypes = reduceTypes((0, _dispatcher.useDispatcher)()));
};

exports.useActions = useActions;
var ACTION_TYPES = ACTION_TYPES_ARRAY.reduce(function (acc, type) {
  return _objectSpread({}, acc, _defineProperty({}, type, type));
}, {});
/**
...
},{"./dispatcher":"dispatcher.jsx"}],"Store.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Store = exports.useStore = exports.StoreContext = void 0;
...
var reducer = function reducer() {
  var oldState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : init_state;
  ...
  switch (type) {
    case _Actions.ACTION_TYPES.ADD_COUNTER:
      state.count += payload;
      break;
...
var StoreContext = (0, _react.createContext)([init_state, reducer]);
exports.StoreContext = StoreContext;

var useStore = function useStore() {
  /** @type { typeof StoreContext[0] } */
  var state = (0, _react.useContext)(StoreContext)[0];
  return state;
};
...
var Store = function Store(_ref2) {
  ...
  var _useReducer = (0, _react.useReducer)(reducer, init_state),
...
exports.Store = Store;
},{"react":"node_modules/react/index.js","./Actions":"Actions.jsx"}],"Counter.jsx":[function(require,module,exports) {
"use strict";
...
var Counter = function Counter() {
  var _useState = (0, _react.useState)(0),
      ...
      localCount = _useState2[0],
      setLocalCount = _useState2[1];

  var store = (0, _Store.useStore)();

  var _useActions = (0, _Actions.useActions)(),
      ADD_COUNTER = _useActions.ADD_COUNTER;

  var click = function click() {
    return ADD_COUNTER(store.count || 1);
  };

  var localAdd = function localAdd() {
    return setLocalCount(localCount + localCount || 1);
  };

  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("code", null, "Store - ", JSON.stringify(store)), _react.default.createElement("br", null), _react.default.createElement("button", {
    onClick: click
  }, "add global"), _react.default.createElement("code", null, "Counter - ", store.count), _react.default.createElement("br", null), _react.default.createElement("button", {
    onClick: localAdd
  }, "add counter"), _react.default.createElement("code", null, "Local Counter - ", localCount));
};

exports.Counter = Counter;
},{"react":"node_modules/react/index.js","./Store":"Store.jsx","./Actions":"Actions.jsx"}],"App.jsx":[function(require,module,exports) {
"use strict";
...
var App = function App() {
  return _react.default.createElement(_Store.Store, null, _react.default.createElement(_Counter.Counter, null));
};

exports.App = App;
},{"react":"node_modules/react/index.js","./Store":"Store.jsx","./Counter":"Counter.jsx"}],"index.jsx":[function(require,module,exports) {
"use strict";
...
(0, _reactDom.render)(_react.default.createElement(_App.App, null), document.querySelector('#root'));
...
//# sourceMappingURL=/hooks.78399e21.js.map